---
description: Read-only blast-radius / risk / decompose estimator for a GitHub issue — run before /work-issue
argument-hint: '<issue-number>'
allowed-tools: Read, Grep, Glob, Bash(gh:*), Bash(git log:*), Bash(git diff:*)
---

# Scope a GitHub Issue

Estimate the size and risk of issue **#$ARGUMENTS** before any work starts. **Read-only** —
this command writes nothing to GitHub, git, or the filesystem. Its output feeds
...
2. **Read the issue.** `gh issue view $ARGUMENTS --repo <owner/name> --json
