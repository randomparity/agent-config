---
description: Reconcile issue status: labels against real PR/branch state — reset orphaned in-flight issues, strip stale labels from closed issues
argument-hint: '(no args — sweeps the repo)'
allowed-tools: Read, Bash(gh:*), Bash(git branch:*), Bash(git ls-remote:*)
---
