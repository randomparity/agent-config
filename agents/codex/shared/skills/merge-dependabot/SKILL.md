...
description: >-
  Audit Dependabot configuration, evaluate open dependency-update pull
  requests against a clean baseline, group overlapping updates, test each
  unit, and merge only verified safe updates serially. Use when asked to
  review, batch, or merge Dependabot PRs for a GitHub repository.
---
