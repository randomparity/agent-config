...
name: epic
description: >-
  Interview a rough feature idea into a GitHub epic containing a PRD and
  dependency-ordered, born-triaged native sub-issues. Use when a feature spans
  multiple pull requests and the user wants an epic, PRD, decomposition, or
  campaign-ready issue set.
---
# Plan an Epic
