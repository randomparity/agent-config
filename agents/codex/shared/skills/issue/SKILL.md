...
name: issue
description: >-
  Verify, deduplicate, draft, and file a structured GitHub issue grounded in
  actual code, with triage labels and native sub-issue support. Use when asked
  to create or file an issue, turn a reported problem into an issue, or
  decompose an existing issue or epic into child issues.
---
