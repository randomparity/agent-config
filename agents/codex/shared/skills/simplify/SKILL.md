...
name: simplify
description: >-
  Apply a behavior-preserving simplification pass over recent changes: remove
  speculative abstraction, dead code, cleverness, redundancy, and noise, then
  verify with repository guardrails. Use when asked to simplify a diff,
  branch, PR, or recent work.
---
# Simplify
...
Apply the global standards (`~/.codex/AGENTS.md`), in this priority order:
