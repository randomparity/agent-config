...
name: scope
description: >-
  Estimate a GitHub issue's blast radius, risk, complexity, and decomposition
  before implementation. Use when asked to scope an issue, assess whether it
  fits one pull request, or provide grounded sizing to issue and work
  workflows.
---
