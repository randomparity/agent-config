...
name: work-issue
description: >-
  Implement a GitHub issue end to end through scoping, feature-branch setup,
  design, TDD, adversarial review, threat scan, simplification, pull-request
  creation, CI, merge handoff, and cleanup. Use when asked to work, implement,
  or resolve a specific GitHub issue with the repository's full workflow.
---
