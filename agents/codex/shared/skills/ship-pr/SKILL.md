...
name: ship-pr
description: >-
  Push a feature branch, create or update a pull request, and drive it to
  green CI and a mergeable GitHub state. Use when asked to ship, publish, or
  prepare completed work for merge, including as the shipping phase of an
  issue flow.
---
