...
name: compound
description: >-
  Capture a non-obvious, verified problem solved in the current session as a
  durable solution document and, when available, a short memory-system recall
  pointer. Use when asked to compound learning, record a solution, or preserve
  a recurring debugging discovery.
---
