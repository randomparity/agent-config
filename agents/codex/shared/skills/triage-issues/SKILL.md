...
name: triage-issues
description: >-
  Analyze GitHub issues and apply a consistent type, priority, status, risk,
  and effort taxonomy, including bootstrapping missing labels. Use when asked
  to triage issues, label a backlog, prepare issues for work selection, or
  create the label set required by issue workflows.
---
