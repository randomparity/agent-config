...
name: groom
description: >-
  Run a proactive repository maintenance sweep for stale issues, dependency
  freshness outside Dependabot, supply-chain advisories, and deferral records
  past review-by. Use when asked to groom, sweep, or surface maintenance work
