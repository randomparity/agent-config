...
RECORD_PROFILES="adr debt" ~/.codex/skills/decision-records/assets/migrate-records.sh
RECORD_PROFILES="adr debt" ~/.codex/skills/decision-records/assets/migrate-records.sh --write
...
`install.sh` that is `~/.codex/skills/decision-records/assets/`; when you are working in
