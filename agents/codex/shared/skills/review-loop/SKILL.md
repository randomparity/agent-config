...
name: review-loop
description: >-
  Iteratively run an adversarial challenge review, fix or disposition
  defensible findings, write deferral records when needed, and re-review until
  approved or bounded stop conditions fire. Use for code, diffs, specs, ADRs,
  plans, and pre-ship review loops.
---
