...
- **Python** — `~/.codex/languages/python.md`
- **Node/TypeScript** — `~/.codex/languages/typescript.md`
- **Rust** — `~/.codex/languages/rust.md`
- **Bash** — `~/.codex/languages/bash.md`
- **GitHub Actions** — `~/.codex/languages/github-actions.md`
- **Dispatching subagents / parallel fan-outs** — `~/.codex/references/orchestration.md` (worktree placement, fan-out caps, report contract, limit specs)
