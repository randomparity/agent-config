---
name: clean-branches
description: "Sweep local branches whose upstream is gone, remove their worktrees after confirmation, delete them, and report every deletion. Use when asked to clean gone branches or prune stale local branch state."
---
# Clean Gone Branches
