...
exception under `examples/project-review-skills/`. Keep native settings, instruction files,
commands, skills, modes, and MCP files under `agents/<agent>/shared/`; agent-native trees must
not define skills or commands.
